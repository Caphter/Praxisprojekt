namespace ExtendedColliders3DEditor {
    ...
    public class ExtendedColliders3DEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.GetControlRect();
            EditorGUILayout.LabelField(new string[] { "Circle", "Circle - Half", "Cone", "Cone - Half", "Cube", "Cylinder", "Cylinder - Half", "Quad", "Sphere",
                    "Triangle", "Dodecahedron", "Icosahedron", "Octahedron" }[(int) colliderType] + " Settings", EditorStyles.boldLabel);
            ...
            if (GUI.Button(new Rect(rect.xMax - 100, rect.yMin, 100, rect.height), "Version 1.0.6", versionStyle)) {
